...
export const helpCategories = {
  ...
  'hi-IN': [
      ...
      questions: [
        {
          ...
          answer: 'चुनाव के दिन अपने मतदान केंद्र पर अपना Voter ID (मतदाता पहचान पत्र) लेकर जाएं। अधिकारी को अपना पहचान पत्र दिखाएं। वे आपकी उंगली पर स्याही लगाएंगे। फिर ईवीएम मशीन का उपयोग करके अपने चुने हुए उम्मीदवार के बगल में बटन दबाएं।',
          relatedQuestions: ['what-is-evm', 'polling-station-timings', 'what-to-bring']
        },
        {
          id: 'what-is-evm',
        ...
        },
        {
          ...
          answer: 'अपना Voter ID (मतदाता पहचान पत्र) लाएं। अगर आपके पास नहीं है, तो आप आधार, पासपोर्ट, ड्राइविंग लाइसेंस या पैन कार्ड जैसे अन्य पहचान पत्र उपयोग कर सकते हैं। बस एक वैध पहचान पत्र पर्याप्त है।',
          relatedQuestions: ['how-to-vote', 'voter-id-card']
        }
      ]
    },
    {
      id: 'voter-id-eligibility',
      title: 'Voter ID (मतदाता पहचान पत्र) और पात्रता',
      icon: '🪪',
      questions: [
        {
          id: 'voter-id-card',
          question: 'Voter ID (मतदाता पहचान पत्र) क्या है?',
          answer: 'Voter ID यानि मतदाता पहचान पत्र (जिसे ईपीआईसी भी कहा जाता है) चुनाव आयोग द्वारा जारी एक पहचान पत्र है। यह साबित करता है कि आप वोट करने के लिए पंजीकृत हैं और चुनाव के दिन वोट करने में मदद करता है।',
          relatedQuestions: ['how-register', 'voter-id-lost']
        },
        {
          id: 'how-register',
        ...
        {
          id: 'voter-id-lost',
          question: 'यदि मैंने अपना Voter ID (मतदाता पहचान पत्र) खो दिया तो क्या करें?',
          answer: 'आप आधार, पासपोर्ट, ड्राइविंग लाइसेंस या पैन कार्ड जैसे अन्य पहचान पत्र का उपयोग करके भी वोट कर सकते हैं। डुप्लीकेट Voter ID प्राप्त करने के लिए nvsp.in पर ऑनलाइन आवेदन करें या अपने चुनाव कार्यालय जाएं।',
          relatedQuestions: ['what-to-bring', 'voter-id-card']
        }
      ]
    },
